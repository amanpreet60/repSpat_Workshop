...
| [`multiple_comparison()`](https://amanpreet60.github.io/repSpat_Workshop/articles/function_reference/multiple_comparison.md) | Pairwise MMD^2 comparison between all clusters, with multiple-testing correction. |
...
| [`pairwise_results_to_matrix()`](https://amanpreet60.github.io/repSpat_Workshop/articles/function_reference/pairwise_results_to_matrix.md) | Build a cluster similarity matrix and network plot from MMD^2 results. |

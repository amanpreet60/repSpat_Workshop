...
Draws a spatial scatter plot of all cells, colored by their assigned region label.

## Arguments

| Argument | Description |
| --- | --- |
| `adata` | AnnData object with region labels assigned (see [`spatial_constrained_hac()`](spatial_constrained_hac.html)). |

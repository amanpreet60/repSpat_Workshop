...
For every cluster, draws a spatial highlight next to a chart of its most defining features. Binary features are shown as presence rates within the cluster; if no binary features are available, continuous features are shown as cluster-vs-rest standardized enrichment scores.

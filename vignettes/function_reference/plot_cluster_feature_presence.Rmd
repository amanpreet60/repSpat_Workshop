...
For every region, draws a spatial highlight next to a chart of its most defining features. Binary features are shown as presence rates within the region; if no binary features are available, numeric features are shown as cluster-vs-rest standardized enrichment scores.
